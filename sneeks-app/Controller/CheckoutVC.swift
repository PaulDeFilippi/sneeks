...
extension CheckoutVC: STPPaymentContextDelegate {
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPPaymentStatusBlock) {
        // An idempotency key is a unique value generated by the client which the server uses to recognize subsequent retries of the same request. Having an idempotency key protects a customer from getting charged twice when the connection is unstable and fails during the initial attempt.
